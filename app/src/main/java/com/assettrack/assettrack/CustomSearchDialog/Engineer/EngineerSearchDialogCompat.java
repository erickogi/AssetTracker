...
public class EngineerSearchDialogCompat<T extends Searchable> extends BaseSearchDialogCompat<T> {
    private String mTitle;
    private String mSearchHint;
    private SearchResultListener<T> mSearchResultListener;

    public EngineerSearchDialogCompat(Context context, String title, String searchHint,
    ...
    protected void getView(View view) {
        ...
        final EngineerModelAdapter adapter = new EngineerModelAdapter<>(getContext(),
                R.layout.engineer_item_view, getItems());
        ...
        setFilterResultListener(new FilterResultListener<T>() {
            ...
            public void onFilter(ArrayList<T> items) {
                ((EngineerModelAdapter) getAdapter())
    ...
    public EngineerSearchDialogCompat setTitle(String title) {
        mTitle = title;
        return this;
    }

    public EngineerSearchDialogCompat setSearchHint(String searchHint) {
        mSearchHint = searchHint;
        return this;
    }

    public EngineerSearchDialogCompat setSearchResultListener(
            SearchResultListener<T> searchResultListener) {
        mSearchResultListener = searchResultListener;
        return this;
    }
