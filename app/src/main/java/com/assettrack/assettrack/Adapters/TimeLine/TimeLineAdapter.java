...
import com.assettrack.assettrack.Utils.VectorDrawableUtils;
    ...
    public void onBindViewHolder(TimeLineViewHolder holder, int position) {
        ...
        try {
            ...
            if (!timeLineModel.getDate().isEmpty()) {
                ...
                holder.mDate.setText(DateTimeUtils.Companion.parseDateTime(timeLineModel.getDate(), "yyyy-MM-dd", "dd-MMM-yyyy"));
            } else {
