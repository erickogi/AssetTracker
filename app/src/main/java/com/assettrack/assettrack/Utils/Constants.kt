...
class Constants {
    val HYYYY_MM_DD = "yyyy-MM-dd"
    val HYYYY_DD_MM = "yyyy-dd-MM"
    val HMM_DD_YYYY = "MM_dd_yyyy"
    val HDD_MM_YYYY = "dd-MM-yyyy"
    val SYYYY_MM_DD = "yyyy/MM/dd"
    val SYYYY_DD_MM = "yyyy/dd/MM"
    val SMM_DD_YYYY = "MM/dd/yyyy"
    val SDD_MM_YYYY = "dd/MM/yyyy"
